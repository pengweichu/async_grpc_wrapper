...
Greeter::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_SayHi_(Greeter_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Greeter::Stub::SayHi(::grpc::ClientContext* context, const ::helloworld::HiRequest& request, ::helloworld::HiReply* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_SayHi_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::helloworld::HiReply>* Greeter::Stub::AsyncSayHiRaw(::grpc::ClientContext* context, const ::helloworld::HiRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::helloworld::HiReply>(channel_.get(), cq, rpcmethod_SayHi_, context, request);
}
...
Greeter::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Greeter::Service, ::helloworld::HiRequest, ::helloworld::HiReply>(
